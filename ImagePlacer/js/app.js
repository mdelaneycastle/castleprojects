const App = {
    ...
    async init() {
        ...
        this.btnWide = document.getElementById('btn-wide');
        this.btnTall = document.getElementById('btn-tall');
    ...
    setupEventListeners() {
        ...
        this.btnWide.addEventListener('click', () => {
            this.setOrientation('wide');
        });
        this.btnTall.addEventListener('click', () => {
            this.setOrientation('tall');
        });
    },

    setOrientation(orientation) {
        this.btnWide.classList.toggle('active', orientation === 'wide');
        this.btnTall.classList.toggle('active', orientation === 'tall');
        BackgroundManager.setLargeOrientation(orientation);
    },
    ...
    onWidthChange() {
        ...
        if (isNaN(width) || width <= 0) {
            ...
            this.orientationToggle.classList.remove('visible');
            return;
        }
        ...
        // Show/hide orientation toggle for large category
        if (category === 'large') {
            this.orientationToggle.classList.add('visible');
        } else {
            this.orientationToggle.classList.remove('visible');
        }
    ...
    onReset() {
        ...
        // Reset orientation toggle
        this.orientationToggle.classList.remove('visible');
        this.btnWide.classList.add('active');
        this.btnTall.classList.remove('active');
        BackgroundManager.largeOrientation = 'wide';
